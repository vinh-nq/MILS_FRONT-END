  ...
  return (
    <>
      <Row className="px-2" gutter={[16, 16]}>
        <Col span={24}>
          <span className="font-weight-500">{t("LOCATION_OF_HOUSEHOLD")}</span>:{" "}
          {changeYesNoForQuestion(DevelopmentFamilyViewModel.Dev1_1)}
        </Col>
        <Col span={24}>
          <span className="font-weight-500">{t("LAND_CERTIFICATE")}</span>:{" "}
        ...
        <Col span={24}>
          <span className="font-weight-500">{t("A_CULTURAL_FAMILY")}</span>:{" "}
        ...
        <Col span={24}>
          <span className="font-weight-500">{t("A_UNITED_FAMILY")}</span>:{" "}
        ...
        <Col span={24}>
          <span className="font-weight-500">{t("A_DRUG_FREE_FAMILY")}</span>:{" "}
