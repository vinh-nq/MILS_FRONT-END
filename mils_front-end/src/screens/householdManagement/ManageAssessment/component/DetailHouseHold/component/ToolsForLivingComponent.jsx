...
function ToolsForLivingComponent(props) {
    ...
    const {StableOccupationAndIncome, dataLanguage, changeYesNoForQuestion} = props;
    return (
        <Row className="px-2" gutter={[16, 16]}>
            ...
            <Col span={24} md={12}>
                <span className="font-weight-500">{t("SOURCES_OTHER_THAN_THEIR_MAIN_SOURCE_OF_INCOME")}</span>:{" "}
            ...
            <Col span={24} md={12}>
                <span className="font-weight-500">{t("DOES_ANY_FAMILY_MEMBER_RUN_ANY_FARM_ON_THEIR_OWN_LAND_OR_LEASED_LAND")}</span>:{" "}
            ...
            <Col span={24} md={12}>
                <span className="font-weight-500">{t("LIVESTOCK_RAISING_IN_THE_LAST_12_MONTHS")}</span>:{" "}
                {changeYesNoForQuestion(StableOccupationAndIncome.LiveStock)}
            </Col>
            <Col span={24} md={12}>
                <span className="font-weight-500">{t("LOWER_SECONDARY_EDUCATION")}</span>:{" "}
