    ...
    return (
        <>
            <Row className="mb-2" gutter={16}>
                <Col span={24} md={12}>
                    <Text className="font-13 font-weight-500">Drinking water facility during dry season</Text>
                    <Form.Item
                        ...
                        rules={[
                            {
                                required: true,
                                message: `${t("Drinking water facility during dry season")} ${t("is_not_empty")}`,
                            },
                        ]}
                    >
                        <Select>
                ...
                <Col span={24} md={12}>
                    <Text className="font-13 font-weight-500">Drinking water facility during rainy</Text>
                    <Form.Item
            ...
            <Row className="mb-2" gutter={16}>
                <Col span={24} md={12}>
                    <Text className="font-13 font-weight-500">Main source for cooking</Text>
                    <Form.Item
                    ...
                    >
                        <Select>
                            {renderSelect(cooking)}
                        </Select>
                    </Form.Item>
                </Col>
                <Col span={24} md={12}>
                    <Text className="font-13 font-weight-500">Main source of energy for lighting</Text>
                    <Form.Item
                        ...
                        rules={[
                            {
                                required: true,
                                message: `${t("Main source of energy for lighting")} ${t("is_not_empty")}`,
                            },
                        ]}
                    >
                        <Select>
