...
function ModaItem(props) {
  ...
  return (
    <Modal
      ...
      width="630px"
      okButtonProps={{
        form: "form-schoolEnroll-management",
        key: "submit",
        htmlType: "submit",
        type: "primary",
      }}
          ...
          rules={[
            {
              validator(rule, value) {
                return handleValidateFrom(
                  ...
                  value,
                  {
                    ...objectValidateForm.schoolEnrollId,
          ...
          rules={[
            {
              validator(rule, value) {
                return handleValidateFrom(
                  rule,
                  value,
                  objectValidateForm.schoolEnrollLao,
                  t
                );
              },
            },
          ...
          rules={[
            {
              validator(rule, value) {
                return handleValidateFrom(
                  rule,
                  value,
                  objectValidateForm.schoolEnrollEng,
                  t
                );
              },
            },
