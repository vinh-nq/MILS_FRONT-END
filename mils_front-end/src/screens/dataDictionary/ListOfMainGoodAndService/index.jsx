...
let timeOut = "";
export default function ListOfMainGoodAndService(props) {
  ...
  useEffect(() => {
    ...
    if (!regexTemplate.NUMBER.test(pageCheck)) {
      props.history.push(PATH.LIST_OF_MAIN_GOOD_AND_SERVICES);
    } else {
      setPage(pageCheck);
    }
  ...
  const columns = [
    {
      title: t("mainGoodAndServiceId"),
      dataIndex: "Id",
      key: "Id",
    },
    {
      title: t("mainGoodAndServiceLao"),
  ...
  const onSearchChange = (e) => {
    ...
    timeOut = setTimeout(() => {
      ...
      props.history.push({
        pathName: PATH.LIST_OF_MAIN_GOOD_AND_SERVICES,
        search: link,
      });
    }, 400);
  };
  ...
  return (
    <div className="w-100 h-100">
      ...
      <div className="d-flex flex-row align-items-center justify-content-between">
        <span className="h5 mb-0">{t("LISTOFMAINGOODANDSERVICES")}</span>
