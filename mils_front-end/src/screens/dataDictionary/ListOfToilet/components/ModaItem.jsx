...
function ModaItem(props) {
  ...
  return (
    <Modal
      ...
      forceRender
    >
      <Form id="form-toilet-management" form={form} onFinish={handleSubmit}>
        <div>
          <span>{t("toiletId")}</span>
