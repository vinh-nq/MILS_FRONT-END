...
function ModaItem(props) {
  ...
  return (
    <Modal
      ...
      width="630px"
      okButtonProps={{
        form: "form-drinkingwater-management",
        key: "submit",
        htmlType: "submit",
        type: "primary",
      }}
          ...
          rules={[
            {
              validator(rule, value) {
                return handleValidateFrom(
                  ...
                  value,
                  {
                    ...objectValidateForm.drinkingWaterId,
          ...
          rules={[
            {
              validator(rule, value) {
                return handleValidateFrom(
                  rule,
                  value,
                  objectValidateForm.drinkingWaterLao,
                  t
                );
              },
            },
          ...
          rules={[
            {
              validator(rule, value) {
                return handleValidateFrom(
                  rule,
                  value,
                  objectValidateForm.drinkingWaterEng,
                  t
                );
              },
            },
