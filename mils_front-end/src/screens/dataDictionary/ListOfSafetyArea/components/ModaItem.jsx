...
function ModaItem(props) {
  ...
  return (
    <Modal
      ...
      width="630px"
      okButtonProps={{
        form: "form-safetyArea-management",
        key: "submit",
        htmlType: "submit",
        type: "primary",
      }}
      ...
      forceRender
    >
      <Form id="form-safetyArea-management" form={form} onFinish={handleSubmit}>
        <div>
          <span>{t("safetyAreaId")}</span>
          ...
          rules={[
            {
              validator(rule, value) {
                return handleValidateFrom(
                  ...
                  value,
                  {
                    ...objectValidateForm.safetyAreaId,
          ...
          rules={[
            {
              validator(rule, value) {
                return handleValidateFrom(
                  rule,
                  value,
                  objectValidateForm.safetyAreaLao,
                  t
                );
              },
            },
          ...
          rules={[
            {
              validator(rule, value) {
                return handleValidateFrom(
                  rule,
                  value,
                  objectValidateForm.safetyAreaEng,
                  t
                );
              },
            },
